module.exports={
      ...
      getorderproductsforadmin:"select s.*,d.size,c.tm_name as colorName from sargytproductler as s inner join disqounts as d on d.id=s.pc_id inner join renkler as c on d.color_id=c.id where sargytlar_id=$1",
